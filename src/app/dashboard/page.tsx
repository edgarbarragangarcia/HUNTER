        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="p-6 rounded-2xl card-gradient shadow-glow">
                    <h3 className="text-lg font-medium text-muted-foreground mb-2">Licitaciones Activas</h3>
                    <p className="text-4xl font-bold text-foreground">0</p>
                </div>
                <div className="p-6 rounded-2xl card-gradient shadow-glow">
                    <h3 className="text-lg font-medium text-muted-foreground mb-2">Alertas Nuevas</h3>
                    <p className="text-4xl font-bold text-primary">0</p>
                </div>
                <div className="p-6 rounded-2xl card-gradient shadow-glow">
                    <h3 className="text-lg font-medium text-muted-foreground mb-2">Documentos</h3>
                    <p className="text-4xl font-bold text-foreground">0</p>
                </div>
            </div>
